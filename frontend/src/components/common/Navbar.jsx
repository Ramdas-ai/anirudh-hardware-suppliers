...
const navLink = ({ isActive }) =>
  `font-display uppercase tracking-wide text-sm transition-colors ${
    isActive
      ? 'text-safety-amber'
      : 'text-warm-white hover:text-safety-amber'
  }`
      ...
      <div className="bg-ink-navy text-warm-white">
        <div className="mx-auto flex max-w-7xl items-center gap-4 px-4 py-3 md:px-6">
          ...
          >
            ...
            <button
              type="submit"
              className="bg-safety-amber px-4 font-display font-bold text-ink-navy"
            >
              Search
            </button>
          </form>
          ...
          <nav className="hidden items-center gap-6 md:flex">
            ...
            {user ? (
              <div className="flex items-center gap-3">
                ...
                <button
                  onClick={logout}
                  className="font-display text-sm uppercase tracking-wide text-warm-white/70 hover:text-safety-amber"
                >
                  Log Out
                </button>
              </div>

...
const KATHMANDU_VALLEY_CITIES = [
    'kathmandu',
    'lalitpur',
    'bhaktapur',
]

function calculateDeliveryCharge(subtotal, city, province) {
    ...
    if (KATHMANDU_VALLEY_CITIES.includes(normalizedCity)) {
        return 150
    }

    return DELIVERY_RATES[normalizedProvince] || 500
}
...
export const createOrder = asyncHandler(async(req, res) => {
    ...
    console.log('BACKEND ORDER BODY:', JSON.stringify(req.body, null, 2))
